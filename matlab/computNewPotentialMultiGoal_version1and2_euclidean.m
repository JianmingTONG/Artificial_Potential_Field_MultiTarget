function output = computNewPotentialMultiGoal_version1and2_euclidean(infoGain, curr, target, obstacle, path)
...
for i=1:size(obstacle, 2)
   ...
   dis_obstacle  = norm(curr - obstacle(:,i));
